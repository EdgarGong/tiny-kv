...
// WriteBatch :code to batch writes into a single, atomic 'transaction'.
// for CF
type WriteBatch struct {
	entries       []*badger.Entry  //Entry is used to set k-v
	size          int
	safePoint     int
	safePointSize int
	safePointUndo int
